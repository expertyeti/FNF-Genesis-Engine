/**
 * @file NoteSplashLogic.js
 * Contiene la lógica y el Manager para procesar los impactos perfectos (Splashes).
 */
	...
	setupEvents() {
		if (funkin.playNotes) {
			funkin.playNotes.event("noteHit", (hitData) => {
                ...
                // 🚨 RESTRICCIÓN DE BOTPLAY: No mostrar splashes si es automático
                ...
                const isOpponent = !hitData.isPlayer;

				if (isOpponent && !is2P) return;
