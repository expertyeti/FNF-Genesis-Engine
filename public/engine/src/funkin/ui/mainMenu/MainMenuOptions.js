/**
 * @file MainMenuOptions.js
 * Maneja la precarga de assets y la estructura de datos visual del menú.
 */
class MainMenuOptions {
  static preload(scene) {
    const path = window.BASE_URL + "assets/images/menu/mainmenu/";
    scene.load.atlasXML(
      "storymode",
      `${path}storymode.png`,
      `${path}storymode.xml`,
    ...
    scene.load.atlasXML(
      "multiplayer",
      `${path}multiplayer.png`,
      `${path}multiplayer.xml`,
    );
    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          animations: [
            {
              name: "multiplayer basic",
              anim: "idle",
              fps: frameRate,
              loop: true,
            },
            {
              name: "multiplayer white",
              anim: "selected",
              fps: frameRate,
              loop: true,
            },
...
funkin.ui.mainMenu.MainMenuOptions = MainMenuOptions;
