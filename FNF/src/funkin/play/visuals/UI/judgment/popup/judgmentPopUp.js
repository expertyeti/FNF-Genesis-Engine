/**
 * @file src/funkin/play/visuals/UI/judgment/popup/judgmentPopUp.js
 */
        ...
        if (funkin.playNotes) {
            funkin.playNotes.event('noteHit', (hitData) => {
                ...
                if (isMyNote && hitData.pressed && hitData.judgment !== 'miss') {
                    this.spawnJudgment(hitData.judgment);
                }
            });
        }
    }
...
funkin.JudgmentPopUpManager = JudgmentPopUpManager;